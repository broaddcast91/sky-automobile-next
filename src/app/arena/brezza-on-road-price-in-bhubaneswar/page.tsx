...
export const metadata: Metadata = {
  ...
  description:
    "Explore the Maruti Suzuki Brezza compact SUV in Bhubaneswar. Check out its on-road prices, features, and book a test drive at Sky Maruti Suzuki Bhubaneswar",
};
