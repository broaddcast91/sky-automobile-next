...
export const metadata: Metadata = {
  ...
  description:
    "Discover the all-new Maruti Suzuki Invicto in Raipur. A premium MPV that combines luxury, performance, and comfort. Explore its features, on-road price, and book a test drive at Sky Maruti Suzuki.",
};
