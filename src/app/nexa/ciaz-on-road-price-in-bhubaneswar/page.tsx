...
export const metadata: Metadata = {
  ...
  description:
    "Check out the luxurious NEXA Ciaz sedan in Bhubaneswar. Discover its on-road price, premium features, and exclusive offers at NEXA Sky Maruti Suzuki Bhubaneswar.",
};
const Ciaz: React.FC = () => {
  return (
    <div> 
